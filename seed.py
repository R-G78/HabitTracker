...
#Local imports
from db import get_db, add_habit, check_habit_exists, add_completion, reset_database, create_tables
...
def seed_demo_data(db = None):
    ...
    Ensure “Drink water” has no breaks for clean streak testing
    ...
    for name, periodicity in habits:
        check_habits = check_habit_exists(db, name, periodicity)
